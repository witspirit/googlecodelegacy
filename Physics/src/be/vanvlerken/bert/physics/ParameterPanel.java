...
public class ParameterPanel extends JPanel implements ChangeListener {
	...
	runtimePanel.setBorder(BorderFactory.createTitledBorder(BorderFactory.createEtchedBorder(), "Runtime Changeable"));
	...
	spinnerGravityCte.setModel(new SpinnerNumberModel(PhysicsParameters.gravityCte, Double.MIN_VALUE, Double.MAX_VALUE, 0.01));
	...
	spinnerTimeStep.setModel(new SpinnerNumberModel(PhysicsParameters.timeStep, 0, Double.MAX_VALUE, 0.0001));
	...
	spinnerNrOfTimeSteps.setModel(new SpinnerNumberModel(PhysicsParameters.nrOfTimeSteps, 0, Integer.MAX_VALUE, 1));
	...
	spinnerMsBetweenIterations.setModel(new SpinnerNumberModel(PhysicsParameters.msBetweenIterations, 0, Integer.MAX_VALUE, 1));
	...
	simRestartPanel.setLayout(new BoxLayout(simRestartPanel, BoxLayout.X_AXIS));
	simRestartPanel.setBorder(BorderFactory.createTitledBorder(BorderFactory.createEtchedBorder(), "Reset required"));
	...
	spinnerNrOfElements.setModel(new SpinnerNumberModel(PhysicsParameters.nrOfElements, 0, Integer.MAX_VALUE, 1));
	...
	spinnerMaxRadius.setModel(new SpinnerNumberModel(PhysicsParameters.maxRadius, 0, Integer.MAX_VALUE, 1));
	...
	spinnerMaxInitialSpeed.setModel(new SpinnerNumberModel(PhysicsParameters.maxInitialSpeed, 0, Double.MAX_VALUE, 1));
	...
	if (e.getSource() == spinnerMsBetweenIterations) {
	    PhysicsParameters.msBetweenIterations = ((SpinnerNumberModel) spinnerMsBetweenIterations.getModel()).getNumber().intValue();
	} else if (e.getSource() == spinnerNrOfTimeSteps) {
	    PhysicsParameters.nrOfTimeSteps = ((SpinnerNumberModel) spinnerNrOfTimeSteps.getModel()).getNumber().intValue();
	} else if (e.getSource() == spinnerTimeStep) {
	    PhysicsParameters.timeStep = ((SpinnerNumberModel) spinnerTimeStep.getModel()).getNumber().doubleValue();
	} else if (e.getSource() == spinnerGravityCte) {
	    PhysicsParameters.gravityCte = ((SpinnerNumberModel) spinnerGravityCte.getModel()).getNumber().doubleValue();
	    ...
	    PhysicsParameters.nrOfElements = ((SpinnerNumberModel) spinnerNrOfElements.getModel()).getNumber().intValue();
	} else if (e.getSource() == spinnerMaxRadius) {
	    PhysicsParameters.maxRadius = ((SpinnerNumberModel) spinnerMaxRadius.getModel()).getNumber().intValue();
	} else if (e.getSource() == spinnerMaxInitialSpeed) {
	    PhysicsParameters.maxInitialSpeed = ((SpinnerNumberModel) spinnerMaxInitialSpeed.getModel()).getNumber().doubleValue();
	}
