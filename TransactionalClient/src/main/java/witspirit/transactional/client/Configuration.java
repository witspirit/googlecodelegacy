...
public class Configuration<REQUEST> {
	...
	this(requestHandler, Arrays.asList(0, 0, 0), Arrays.asList(60, 5 * 60, 60 * 60, 2 * 60 * 60));
    }

    public Configuration(RequestHandler<REQUEST> requestHandler, List<Integer> repeatIntervalsInSeconds, List<Integer> reversalIntervalsInSeconds) {
