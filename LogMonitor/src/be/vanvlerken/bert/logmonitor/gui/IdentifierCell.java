...
public class IdentifierCell implements IColoredTextCell
{
    ...
    public String toString()
    {
        ...
        switch (identifier)
        {
            case ILogEntry.ERROR    : errorLevel = "ERROR"; break;
            case ILogEntry.WARNING  : errorLevel = "WARNING"; break;
            case ILogEntry.INFO     : errorLevel = "INFO"; break;
            case ILogEntry.VERBOSE  : errorLevel = "VERBOSE"; break;
            default:
                errorLevel = "UNKNOWN";
        }
