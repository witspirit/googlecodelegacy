 ...
 * Renders a SeqNrCell
 */
public class ColoredLongCellRenderer extends JLabel implements TableCellRenderer
{
    public ColoredLongCellRenderer(int alignment)
    {
        super();
	...
	public Component getTableCellRendererComponent(
		...
		int column)
	{
        IColoredLongCell cell = (IColoredLongCell) value;
        
        setBackground(cell.getColor());
        setText((new Long(cell.getValue())).toString());
