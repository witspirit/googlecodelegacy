...
/**
 * This application performs a small simulation of a gravitational force on some objects. It's been done many times by lot's of people,but I want to understand
 * it as well...
 */
public class Physics implements Runnable, ShutdownListener, ActionListener {
	...
	logger.debug("Setting the ApplicationWindow size to " + PhysicsParameters.simulationWidth + "x" + PhysicsParameters.simulationHeight);
	appWindow.setSize(PhysicsParameters.simulationWidth, PhysicsParameters.simulationHeight);
