...
public class VerifyGroupPoolAction extends AbstractAction
{
            ...
            if (groupFuture.isDone())
            {
                ...
                catch (ExecutionException e)
                {
                    ...
                    if (cause instanceof FlickrCommunicationException)
                    {
                        ...
                        JOptionPane.showMessageDialog(null, cause.getMessage(), "Communication problem",
    ...
    public VerifyGroupPoolAction(AsyncBrowser browser, StatusBar statusBar, UrlProvider urlProvider,
            GroupPoolDescription groupPoolDescription)
    {
        super("Verify");
