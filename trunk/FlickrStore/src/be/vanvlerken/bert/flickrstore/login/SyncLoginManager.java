...
public class SyncLoginManager
{
     ...
     */
    public void login(AuthorizationHandler authHandler) throws FlickrAuthorizationRequiredException,
            FlickrCommunicationException
    {
            ...
            if (stringToken == null)
            {
                ...
                catch (FlickrException fe)
                {
                    ...
                    throw new FlickrAuthorizationRequiredException(
                            "This application has not been granted the appropriate rights. Please authorize the application.",
                            fe);
                }
            }
